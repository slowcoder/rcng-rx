...
static int mini_strcmp(char *pA,char *pB) {
...
#if 1
	if(      mini_strcmp(params[0],"ps")    == 0 ) clicmd_PS(argc,params);
	else if( mini_strcmp(params[0],"uname") == 0 ) clicmd_UNAME(argc,params);
	else if( mini_strcmp(params[0],"info")  == 0 ) clicmd_INFO(argc,params);
	else if( mini_strcmp(params[0],"free")  == 0 ) clicmd_FREE(argc,params);
	else if( mini_strcmp(params[0],"help")  == 0 ) {
